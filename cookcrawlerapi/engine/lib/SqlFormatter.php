...
class SqlFormatter
{
    ...
    public static $cli_quote = "[34;1m";
    public static $cli_backtick_quote = "[35;1m";
    public static $cli_reserved = "[37m";
    public static $cli_boundary = "";
    public static $cli_number = "[32;1m";
    public static $cli_word = "";
    public static $cli_error = "[31;1;7m";
    public static $cli_comment = "[30;1m";
    public static $cli_functions = "[37m";
    public static $cli_variable = "[36;1m";
...
".self::highlightError("WARNING: unclosed parentheses or section");
    ...
    {
        if (self::is_cli()) {
            return self::$cli_quote . $value . "[0m";
        } else {
    ...
    {
        if (self::is_cli()) {
            return self::$cli_backtick_quote . $value . "[0m";
        } else {
    ...
    {
        if (self::is_cli()) {
            return self::$cli_reserved . $value . "[0m";
        } else {
    ...
    protected static function highlightBoundary($value)
    {
        ...
        if (self::is_cli()) {
            return self::$cli_boundary . $value . "[0m";
        } else {
    ...
    {
        if (self::is_cli()) {
            return self::$cli_number . $value . "[0m";
        } else {
    ...
    {
        if (self::is_cli()) {
            return self::$cli_error . $value . "[0m";
        } else {
    ...
    {
        if (self::is_cli()) {
            return self::$cli_comment . $value . "[0m";
        } else {
    ...
    {
        if (self::is_cli()) {
            return self::$cli_variable . $value . "[0m";
        } else {
